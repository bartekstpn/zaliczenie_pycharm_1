...
print(f'Twoja pozostała kwota kredytu to:" {kwota_czerwiec_2022}, "to {kwota_maj_2022 - kwota_czerwiec_2022} mniej niż w poprzednim miesiącu.')
print(f'Twoja pozostała kwota kredytu to:" {kwota_lipiec_2022}, "to {kwota_czerwiec_2022 - kwota_lipiec_2022} mniej niż w poprzednim miesiącu.')
print(f'Twoja pozostała kwota kredytu to:" {kwota_sierpień_2022}, "to {kwota_lipiec_2022 - kwota_sierpień_2022} mniej niż w poprzednim miesiącu.')
print(f'Twoja pozostała kwota kredytu to:" {kwota_wrzesień_2022}, "to {kwota_sierpień_2022 - kwota_wrzesień_2022} mniej niż w poprzednim miesiącu.')
print(f'Twoja pozostała kwota kredytu to:" {kwota_październik_2022}, "to {kwota_wrzesień_2022 - kwota_październik_2022} mniej niż w poprzednim miesiącu.')
print(f'Twoja pozostała kwota kredytu to:" {kwota_listopad_2022}, "to {kwota_październik_2022 - kwota_listopad_2022} mniej niż w poprzednim miesiącu.')
print(f'Twoja pozostała kwota kredytu to:" {kwota_grudzień_2022}, "to {kwota_listopad_2022 - kwota_grudzień_2022} mniej niż w poprzednim miesiącu.')
print(f'Twoja pozostała kwota kredytu to:" {kwota_styczeń_2023}, "to {kwota_grudzień_2022 - kwota_styczeń_2023} mniej niż w poprzednim miesiącu.')
print(f'Twoja pozostała kwota kredytu to:" {kwota_luty_2023}, "to {kwota_styczeń_2023 - kwota_luty_2023} mniej niż w poprzednim miesiącu.')
print(f'Twoja pozostała kwota kredytu to:" {kwota_marzec_2023}, "to {kwota_luty_2023 - kwota_marzec_2023} mniej niż w poprzednim miesiącu.')
print(f'Twoja pozostała kwota kredytu to:" {kwota_kwiecień_2023}, "to {kwota_marzec_2023 - kwota_kwiecień_2023} mniej niż w poprzednim miesiącu.')
print(f'Twoja pozostała kwota kredytu to:" {kwota_maj_2023}, "to {kwota_kwiecień_2023 - kwota_maj_2023} mniej niż w poprzednim miesiącu.')
print(f'Twoja pozostała kwota kredytu to:" {kwota_czerwiec_2023}, "to {kwota_maj_2023 - kwota_czerwiec_2023} mniej niż w poprzednim miesiącu.')
print(f'Twoja pozostała kwota kredytu to:" {kwota_lipiec_2023}, "to {kwota_czerwiec_2023 - kwota_lipiec_2023} mniej niż w poprzednim miesiącu.')
print(f'Twoja pozostała kwota kredytu to:" {kwota_sierpień_2023}, "to {kwota_lipiec_2023 - kwota_sierpień_2023} mniej niż w poprzednim miesiącu.')
print(f'Twoja pozostała kwota kredytu to:" {kwota_wrzesień_2023}, "to {kwota_sierpień_2023 - kwota_wrzesień_2023} mniej niż w poprzednim miesiącu.')
print(f'Twoja pozostała kwota kredytu to:" {kwota_październik_2023}, "to {kwota_wrzesień_2023 - kwota_październik_2023} mniej niż w poprzednim miesiącu.')
print(f'Twoja pozostała kwota kredytu to:" {kwota_listopad_2023}, "to {kwota_październik_2023 - kwota_listopad_2023} mniej niż w poprzednim miesiącu.')
print(f'Twoja pozostała kwota kredytu to:" {kwota_grudzień_2023}, "to {kwota_listopad_2023 - kwota_grudzień_2023} mniej niż w poprzednim miesiącu.')
